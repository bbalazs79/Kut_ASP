#pragma checksum "E:\KutatasModszertan\Kut_ASP\Kutatas_core\Kutatas_core\Views\Home\Cart.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "22b9ebec9fcdc91b90c8fe49862375bf01e8a82b"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"22b9ebec9fcdc91b90c8fe49862375bf01e8a82b", @"/Views/Home/Cart.cshtml")]
...
#line hidden
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "92ce7e45a5034c35bea7a6159aaae08c", async() => {
...
<script>
    ...
    /*function reFresh(item, i) {
        ...
        <div class=""orderedfoods"">
        <div> <h2>${car");
            WriteLiteral(@"tContent[i].Name}</h2></div>
    ...
    function subItem(item) {
        for (let i = 0; i < cartContent.length; i++) {
            if (cartContent[i].id == item.dataset.id && cartContent[i].Count > 1) {
                cartContent[i].Count--;
                sessionStorage.setItem('cart', JSON.stringify(cartCon");
            WriteLiteral(@"tent));
                for (var j = 0; j < cartContent.length; j++) {
                    if (cartContent[j].id == item.dataset.id) {
                        //reFresh(item, i);
    ...
    function deleteItem(item) {
        for (let i = 0; i < cartContent.length; i++) {
            if (cartContent[i].id == item.dataset.id) {
                ...
                /*  frissítjük az adatbázist */
                se");
            WriteLiteral(@"ssionStorage.setItem('cart', JSON.stringify(cartContent));
